      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <span className=' text-center'>
            <img src={Logo} alt="" className='w-64 h-32  bg-white' />
          </span>
        </NavLink>
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <NavLink
                              to="/Dashboard"
                              className={({ isActive }) =>
                                'group relative flex items-center  rounded-md  font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                            Dashboard
