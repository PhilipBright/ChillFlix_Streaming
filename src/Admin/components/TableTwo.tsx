...
const TableTwo = () => {
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="grid grid-cols-7 border-t border-stroke py-4.5  dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
      ...
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        ...
        <div className=" col-span-1 ml-8 h-12.5 w-15 text-sm text-black dark:text-white">
             
              <img src={ProductOne} alt="Product" />
            </div>
            <div className='col-span-1 ml-[48px]  rounded-md'>
            <p >
              Spiderman
            </p>
            </div>
        ...
        <div className="pl-4 col-span-1 flex items-center">
          <p className="text-sm text-black dark:text-white">Thriller</p>
        </div>
        <div className="col-span-1 flex items-center">
          <p className="text-sm text-black dark:text-white">20/2/2017</p>
        </div>
        
        <div className="col-span-1 flex items-center">
          <p className="text-sm text-black dark:text-white">Universal Pictures</p>
        </div>
        <div className="col-span-1 flex items-center">
